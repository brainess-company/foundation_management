...
class FoundationRelatorios(models.Model):
    ...
    #nome_operador = fields.Char(related='service_id.operador_id.name', string="Operador", readonly=True,store=True)
    ...
    # todo substituir nas views service_id por foundation_maquina_registro_id
    # service id
